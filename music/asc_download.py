...
def page_search(key, page=None, current_url=None):      # 当前页搜索歌曲, 返回歌曲编号
    url = ''
...
async def main(lst):
    tasks = [mp3_download_async(code) for code in lst]  # 创建一个任务列表
